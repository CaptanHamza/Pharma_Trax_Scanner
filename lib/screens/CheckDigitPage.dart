                      ...
                      checkLastDigit== null
                          ...
                          : Container(
                              ...
                              decoration: BoxDecoration(
                                  border:
                                      Border.all(width: 1, color: Color(0xFF155724)),
                                  color: customColor,
                                  ...
                                  Expanded(
                                    ...
                                    style: const TextStyle(
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                              color: Color(0xFF155724).withOpacity(0.6),
                              ...
                              checkerroMessage ==true  ? Container(
                              padding: EdgeInsets.symmetric(
                                  horizontal: 10, vertical: 10),
                              decoration: BoxDecoration(
                                  border:
                                      Border.all(width: 1, color: Color(0xFF9d1d26)),
                                  color: customColor,
                                  borderRadius: BorderRadius.circular(8)),
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    style: const TextStyle(
                                        ...
                                        Text(
                                          messageDisplay.toString(),
                                          style: TextStyle(
                                              color:  Color(0xFF9d1d26).withOpacity(0.6),
                                              fontWeight: FontWeight.w400,
                                              letterSpacing: 0.5,
                                              fontSize: 16),
                                        ),
